...
It would take 5000 times; since the friendships are all bidirectional, one call of 
add_friendship() fives friends to two people. (100 users * 10 friends == 10,000;
because it is bidirectional, it cuts the number in half)

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

 After running it a couple times, the average number of people in the person's 
 extended list was 960, so about 96% I would guess (maybe?).
